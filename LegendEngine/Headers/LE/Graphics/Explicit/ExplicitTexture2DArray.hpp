...
namespace le
{
    ...
    {
    public:
        ExplicitTexture2DArray(size_t width, size_t height, uint8_t channels,
    ...
    private:
        ...
        void CopyImagesToBuffer(uint8_t* data, size_t size, const std::span<TextureData*>& textureData);
